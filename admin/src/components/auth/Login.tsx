...
import { login } from "../../redux/features/auth/loginSlice.js";
...
const Login = () => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-100 px-4 sm:relative sm:min-h-screen">
